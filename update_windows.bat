...
rem  3) copies it into the folder: the code folders are replaced, other files stay
...
echo [WARNING] Could not download "%BRANCH%". Trying the main version...
call :fetch main
if errorlevel 1 goto :no_zip
